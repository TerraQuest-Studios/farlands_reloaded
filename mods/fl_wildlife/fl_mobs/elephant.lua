...
minetest.register_entity("fl_wildlife:elephant", {
    ...
    initial_properties = {
        ...
        visual = "mesh",
        mesh = "farlands_mob_elephant.b3d",
        textures = {"farlands_mob_elephant.png"},
    ...
    animation = { --animations, no idea what these are
        ...
        stand = {range = {x=1,y=20}, speed = 7, loop = true}, --aka eating
        walk = {range = {x=25,y=45}, speed = 14, loop = true},
        run = {range = {x=25,y=45}, speed = 50, loop = true},
        --punch = {range = {x=45,y=65}, speed = 10, loop = true},
    },

    brainfunc = elephant_brain,
    _egg_it = {"elephant", "#100c0c"},
    --[[ _spawning = {
        rarity = 0.5,
        light_min = 11,
        cluster = 3,
